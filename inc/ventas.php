...
<div class="container-fluid">
    <div class="row">
        <div class="col-xs-12">
            ...
            <!--div class="form-group">
                <label for="codigo_vendedor">Codigo de Vendedor</label>
                <input class="form-control" type="text" id="codigo_vendedor"
                       placeholder="Ingresa el codigo del Vendedor">
            </div-->
                ...
                <div class="row">
                    <div class="form-group">
                        <div class="col-xs-12 col-md-10">
                            <label for="pago_usuario">El Vendedor/Cliente paga con...</label>
                            <input placeholder="El vendedor/cliente paga con..." type="number" id="pago_usuario"
                                   class="form-control">
                        </div>
                    </div>
